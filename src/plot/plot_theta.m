function plot_theta(input_file_theta, input_file_real_swc, output_png_file)
% plot_theta - Plots modeled and observed soil water content (theta) over time.

%% Load theta data (model output)
data = readtable(input_file_theta);
...
T = readtable(input_file_real_swc);
