...
Our final results are two files of plot : 
-porosity_plot.png
-theta_obsVScomp_plot.png
We have 4 intermediate files of results ( that are reuse to generate the two finale plot ): 
- temp_prec_ray.csv ( generate by 
- dunno
